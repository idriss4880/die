...
//			If the script ended here, it means that it cannot read the file pointer offset.		
 		 ...
 		 <?php
			  ...
			  echo "</p>";
			  echo "<br /><div align=\"center\"><a href=\""._URL."/". _ADMIN_FOLDER ."/login.php\" target=\"_blank\" class=\"btn btn-primary\">Take me to the admin panel &rarr;</a><a href=\"https://urlzs.com/fVT6D\" target=\"_blank\" class=\"btn btn-primary\">PROWEBBER</a></div>";
			  echo "";
//			  $error = 1;
			}
			else
